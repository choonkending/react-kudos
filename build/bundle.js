...
React.render(React.createElement(KudosKen, {interval: "1500"}), document.getElementById('example'));
},{"./kudos":149,"react":148}],2:[function(require,module,exports){
 ...
 */
 ...
 var KudosKen = React.createClass({displayName: 'KudosKen',
 	...
 	render: function(){
 		return (
 			React.createElement("div", {className: 'kudos ' + this.state.phase, onMouseOver: this.phaseEnter, onMouseOut: this.phaseOut})
